...
class Person(val id: Int, val name: String) {
    ...
    //Переопределите метод equals в классе Person, чтобы объекты этого класса считались равными,
    // если у них одинаковые id, независимо от значения поля name.
...
// В каждом тесте отсутствуют операторы сравнения (например, ==, !=, ===, !==, equals, !obj1.equals(obj2)).
// Вам нужно вставить подходящие операторы так, чтобы тесты корректно проверяли условия и проходили успешно.
class TestCases {
    fun runTests() {
